(function (global, factory) {
    ...
    var ValidatorService = /** @class */ (function () {
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.arrayLength(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.base64;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.creditCard;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.date(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.dateISO;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.digits;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.email;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.equal(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.equalTo(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.lt(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.gte(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.json;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.lte(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.max(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.maxDate;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.min(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.minDate(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.notEqual(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.notEqualTo(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.number;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.property(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.range([value.min, value.max]);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.rangeLength([value.min, value.max]);
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.url;
                }
                catch (error) {
                    console.log(error);
                    return null;
         ...
         */
            function (value) {
                try {
                    return ngxCustomValidators.CustomValidators.uuid(value);
                }
                catch (error) {
                    console.log(error);
                    return null;
    ...
    ***************************************************************************** */
    ...
    var Field = /** @class */ (function () {
        ...
        Field.propDecorators = {
            fieldDef: [{ type: i0.Input }],
            group: [{ type: i0.Input }],
            formComponent: [{ type: i0.Input }],
            pageComponent: [{ type: i0.Input }],
    ...
    var CSelectComponent = /** @class */ (function (_super) {
        ...
        CSelectComponent.propDecorators = {
            ngSelectComponent: [{ type: i0.ViewChild, args: ['ngSelect',] }]
        };
    ...
    var CFieldsetComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CFieldsetComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: i0.Renderer2 }
            ];
    ...
    var AutocompleteComponent = /** @class */ (function (_super) {
        ...
        function AutocompleteComponent() {
            var _this = _super !== null && _super.apply(this, arguments) || this;
            _this.fetchOptions$ = new rxjs.Subject();
            return _this;
        }
        /**
         * @protected
         ...
         */
            function () {
                ...
                try {
                    ...
                    this.fetchOptions$
                        .pipe(operators.debounceTime(this._defaults.ACS_FETCH_DEBOUNCE_TIME), operators.distinctUntilChanged())
                        .subscribe(( /**
                 * @param {?} term
                 * @return {?}
                 */function (term) {
                     ...
                     */function (response) {
                         ...
                         * @param {?} error
                         * @return {?}
                         */function (error) { return _this.options$ = rxjs.of([]); }));
                    }));
                }
                catch (error) {
                    console.log(error);
                ...
                try {
                    ...
                    if (searchData && searchData.afterFetchFn) {
                        ...
                        if (afterSearchFn) {
                            ...
                            return rxjs.of(optionsData.options);
                        }
                    }
                    if (response && response.options) {
                        return rxjs.of(response.options);
                    }
                    return rxjs.of([]);
                }
                catch (error) {
        ...
        FieldsModule.decorators = [
            { type: i0.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            timepicker.TimepickerModule.forRoot(),
    ...
    var SimpleFormComponent = /** @class */ (function () {
        function SimpleFormComponent(_fb, _schemaService, _logger, _utilService, _defaults, _elemRef, _renderer) {
            ...
            this._elemRef = _elemRef;
            this._renderer = _renderer;
            this.afterInit = new i0.EventEmitter();
            this.afterGenerateForm = new i0.EventEmitter();
            this._initialize();
        }
        /**
         * @protected
                ...
                try {
                     ...
                     */function (def, index) {
                        ...
                        if (type === 'FST') {
                            ...
                            /** @type {?} */
                            var fldControl = new forms.FormControl();
        ...
        /** @nocollapse */
        SimpleFormComponent.ctorParameters = function () {
            return [
        ...
        SimpleFormComponent.propDecorators = {
            ...
            afterInit: [{ type: i0.Output }],
            afterGenerateForm: [{ type: i0.Output }]
        };
    ...
    exports.SimpleFormGeneratorModule = SimpleFormGeneratorModule;
    exports.ɵa = SimpleFormComponent;
    exports.ɵf = FieldDirective;
    exports.ɵbc = AnchorComponent;
    exports.ɵbe = AutocompleteComponent;
    exports.ɵba = BlankComponent;
    exports.ɵu = CButtonComponent;
    exports.ɵbd = CFieldsetComponent;
    exports.ɵp = CSelectComponent;
    exports.ɵs = CheckboxComponent;
    exports.ɵv = DateTimeComponent;
    exports.ɵm = DateComponent;
    exports.ɵl = ErrorsComponent;
    exports.ɵi = Field;
    exports.ɵy = FileComponent;
    exports.ɵz = HiddenComponent;
    exports.ɵbb = HtmlEditorComponent;
    exports.ɵx = MonthComponent;
    exports.ɵq = MultiselectComponent;
    exports.ɵo = NumberComponent;
    exports.ɵn = PasswordComponent;
    exports.ɵr = RadioComponent;
    exports.ɵt = TextAreaComponent;
    exports.ɵh = TextComponent;
    exports.ɵw = TimeComponent;
    exports.ɵg = FieldsModule;
    exports.ɵj = ValidatorService;
    exports.ɵc = DefaultsService;
    exports.ɵk = HttpService;
    exports.ɵd = LoggerService;
    exports.ɵb = SchemaService;
    exports.ɵe = UtilService;
